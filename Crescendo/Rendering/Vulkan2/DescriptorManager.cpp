...
CS_NAMESPACE_BEGIN::Vulkan
{
	...
	DescriptorManager::DescriptorManager() : device(nullptr), maxDescriptorsPerPool(0) {}
	...
	{
		CS_ASSERT(maxDescriptorsPerPool > 0, "Max Descriptors per pool cannot be O, must be at least 1 or more!");
	}
