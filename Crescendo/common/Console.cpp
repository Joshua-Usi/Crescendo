...
namespace CrescendoEngine
{
	...
	CS_COMMON_EXPORT bool Console::enableThreadSafety = true;
	CS_COMMON_EXPORT std::mutex Console::threadMutex;
	CS_COMMON_EXPORT Console::severity Console::displayedSeverities =
	...
	CS_COMMON_EXPORT bool Console::printSeverity = true;
	CS_COMMON_EXPORT bool Console::printTimestamp = true;
	CS_COMMON_EXPORT std::chrono::time_point<std::chrono::steady_clock> Console::timePoint;
