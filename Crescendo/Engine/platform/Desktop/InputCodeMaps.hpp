...
CS_NAMESPACE_BEGIN
{
	// indices map to GLFW mouse button codes
	...
	const static uint32_t KeyToGLFWMapping[]
	{
		...
		GLFW_KEY_WORLD_1, GLFW_KEY_WORLD_2, // Presumably this is for apple keyboards?
		...
		GLFW_KEY_PAGE_UP, GLFW_KEY_PAGE_DOWN, GLFW_KEY_HOME, GLFW_KEY_END, GLFW_KEY_CAPS_LOCK, GLFW_KEY_SCROLL_LOCK, GLFW_KEY_NUM_LOCK, GLFW_KEY_PRINT_SCREEN, GLFW_KEY_PAUSE,
